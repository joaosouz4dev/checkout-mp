   ...
   <body>
      <div class="container">
         <div class="pagina">
            <?php
               if ($total == 0) {
                  header('Location: https://babyshop.club/'); 
               } else { ?>
            <div class="topo">
         ...
         <div class="logos">
            <div class="logo-mp noselect">
               <img alt="" src="./img/logo-mp.png">
            </div>
            <div class="logo-norton noselect">
               <img alt="" src="./img/Norton_av_logo.png">
            </div>
            <div class="clearfix"></div>
         </div>
      </div>
